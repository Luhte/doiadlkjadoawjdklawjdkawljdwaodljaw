import { AvailableScrappers } from './index.js';
...
export class ScrapperModIoAlienTag {
    async scrape() {
        try {
            const response = await axios.get('https://mod.io/v1/games/@alientag/mods?_limit=100&_offset=0&_sort=-date_live', {
                headers: {
